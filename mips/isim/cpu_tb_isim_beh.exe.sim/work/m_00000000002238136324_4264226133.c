...
#endif
static const char *ng0 = "C:/Users/ThinkPad/Documents/ISE/mips/mips/mips/cpu/expectation/expM.v";
...
LAB14:    memcpy(t98, t11, 8);

LAB15:    memset(t126, 0, 8);
    t127 = (t98 + 4);
...
LAB92:    if (*((unsigned int *)t248) > 0)
        goto LAB93;

LAB94:    if (*((unsigned int *)t4) > 0)
        goto LAB95;

LAB96:    memcpy(t3, t257, 8);
...
LAB32:    if (*((unsigned int *)t45) > *((unsigned int *)t44))
        goto LAB31;
...
LAB64:    memcpy(t173, t146, 8);

LAB65:    memset(t205, 0, 8);
    t206 = (t173 + 4);
...
LAB79:    if (*((unsigned int *)t206) != 0)
        goto LAB80;

LAB81:    t214 = *((unsigned int *)t126);
...
LAB70:    if (*((unsigned int *)t160) > *((unsigned int *)t159))
        goto LAB69;

LAB68:    *((unsigned int *)t161) = 1;

LAB69:    memset(t165, 0, 8);
    t166 = (t161 + 4);
...
LAB75:    t185 = *((unsigned int *)t173);
    t186 = *((unsigned int *)t179);
    *((unsigned int *)t173) = (t185 | t186);
    t187 = (t146 + 4);
    t188 = (t165 + 4);
    t189 = *((unsigned int *)t146);
    t190 = (~(t189));
...
LAB93:    xsi_vlog_unsigned_bit_combine(t3, 32, t252, 32, t257, 32);
    goto LAB97;

LAB95:    memcpy(t3, t252, 8);
    goto LAB97;
...
LAB48:    t414 = (t0 + 2240);
    ...
    *((unsigned int *)t425) = (t427 | t421);
    xsi_driver_vfirst_trans(t414, 0, 4);
    t428 = (t0 + 2160);
    *((int *)t428) = 1;
...
LAB54:    memcpy(t166, t145, 8);

LAB55:    memset(t194, 0, 8);
    t195 = (t166 + 4);
...
LAB68:    memcpy(t233, t194, 8);

LAB69:    memset(t261, 0, 8);
    t262 = (t233 + 4);
...
LAB86:    memcpy(t300, t261, 8);

LAB87:    memset(t328, 0, 8);
    t329 = (t300 + 4);
...
LAB120:    t405 = (t142 + 4);
    t406 = *((unsigned int *)t142);
    t407 = *((unsigned int *)t405);
    t408 = (t406 || t407);
    if (t408 > 0)
        goto LAB121;

LAB122:    t410 = *((unsigned int *)t142);
    t411 = (~(t410));
...
LAB128:    memcpy(t141, t415, 8);

LAB129:    goto LAB43;

LAB44:    xsi_vlog_unsigned_bit_combine(t3, 5, t136, 5, t141, 5);
    goto LAB48;

LAB46:    memcpy(t3, t136, 8);
    goto LAB48;
...
LAB71:    *((unsigned int *)t209) = 1;

LAB73:    memset(t225, 0, 8);
    t226 = (t209 + 4);
...
LAB93:    if (*((unsigned int *)t293) != 0)
        goto LAB94;

LAB95:    t301 = *((unsigned int *)t261);
...
LAB125:    xsi_vlog_unsigned_bit_combine(t141, 5, t409, 5, t415, 5);
    goto LAB129;

LAB127:    memcpy(t141, t409, 8);
    goto LAB129;

}


extern void work_m_00000000002238136324_4264226133_init()
{
	static char *pe[] = {(void *)Cont_33_0,(void *)Cont_36_1};
	xsi_register_didat("work_m_00000000002238136324_4264226133", "isim/cpu_tb_isim_beh.exe.sim/work/m_00000000002238136324_4264226133.didat");
