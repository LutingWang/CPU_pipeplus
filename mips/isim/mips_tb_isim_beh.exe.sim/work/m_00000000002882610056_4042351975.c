...
#endif
static const char *ng0 = "C:/Users/ThinkPad/Documents/ISE/mips-bd/mips/mips/cpu/expectation/expE.v";
...
LAB49:    memcpy(t395, t189, 8);

LAB50:    memset(t423, 0, 8);
    t424 = (t395 + 4);
...
LAB117:    if (*((unsigned int *)t499) != 0)
        goto LAB118;

LAB119:    t506 = (t4 + 4);
    t507 = *((unsigned int *)t4);
    t508 = *((unsigned int *)t506);
    t509 = (t507 || t508);
    if (t509 > 0)
        goto LAB120;

LAB121:    t511 = *((unsigned int *)t4);
    t512 = (~(t511));
...
LAB123:    if (*((unsigned int *)t506) > 0)
        goto LAB124;

LAB125:    if (*((unsigned int *)t4) > 0)
        goto LAB126;

LAB127:    memcpy(t3, t515, 8);
...
LAB60:    memcpy(t276, t229, 8);

LAB61:    memset(t308, 0, 8);
    t309 = (t276 + 4);
...
LAB78:    memcpy(t355, t308, 8);

LAB79:    memset(t387, 0, 8);
    t388 = (t355 + 4);
...
LAB92:    if (*((unsigned int *)t388) != 0)
        goto LAB93;

LAB94:    t396 = *((unsigned int *)t189);
...
LAB70:    t288 = *((unsigned int *)t276);
    t289 = *((unsigned int *)t282);
    *((unsigned int *)t276) = (t288 | t289);
    t290 = (t229 + 4);
    t291 = (t268 + 4);
    t292 = *((unsigned int *)t229);
    t293 = (~(t292));
...
LAB81:    *((unsigned int *)t331) = 1;

LAB83:    memset(t347, 0, 8);
    t348 = (t331 + 4);
...
LAB85:    if (*((unsigned int *)t348) != 0)
        goto LAB86;

LAB87:    t356 = *((unsigned int *)t308);
...
LAB102:    t437 = (t0 + 784U);
    ...
    *((unsigned int *)t436) = (t444 & 63U);
    t445 = *((unsigned int *)t437);
    *((unsigned int *)t437) = (t445 & 63U);
    t446 = ((char*)((ng4)));
    memset(t447, 0, 8);
    t448 = (t436 + 4);
    t449 = (t446 + 4);
...
LAB106:    *((unsigned int *)t447) = 1;

LAB108:    memset(t463, 0, 8);
    t464 = (t447 + 4);
...
LAB120:    t510 = ((char*)((ng5)));
    goto LAB121;

LAB122:    t515 = ((char*)((ng6)));
    goto LAB123;

LAB124:    xsi_vlog_unsigned_bit_combine(t3, 32, t510, 32, t515, 32);
    goto LAB128;

LAB126:    memcpy(t3, t510, 8);
    goto LAB128;
...
LAB34:    t252 = (t0 + 2148);
    ...
    *((unsigned int *)t263) = (t265 | t259);
    xsi_driver_vfirst_trans(t252, 0, 4);
    t266 = (t0 + 2068);
    *((int *)t266) = 1;
...
LAB83:    t243 = (t181 + 4);
    t244 = *((unsigned int *)t181);
    t245 = *((unsigned int *)t243);
    t246 = (t244 || t245);
    if (t246 > 0)
        goto LAB84;

LAB85:    t248 = *((unsigned int *)t181);
    t249 = (~(t248));
...
LAB91:    memcpy(t180, t253, 8);

LAB92:    goto LAB60;

LAB61:    xsi_vlog_unsigned_bit_combine(t91, 5, t175, 5, t180, 5);
    goto LAB65;
...
LAB88:    xsi_vlog_unsigned_bit_combine(t180, 5, t247, 5, t253, 5);
    goto LAB92;

LAB90:    memcpy(t180, t247, 8);
    goto LAB92;

}


extern void work_m_00000000002882610056_4042351975_init()
{
	static char *pe[] = {(void *)Cont_32_0,(void *)Cont_37_1};
	xsi_register_didat("work_m_00000000002882610056_4042351975", "isim/mips_tb_isim_beh.exe.sim/work/m_00000000002882610056_4042351975.didat");
