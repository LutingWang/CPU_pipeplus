...
#endif
static const char *ng0 = "C:/Users/ThinkPad/Documents/ISE/mips-bd/mips/mips/cpu/datapath/4_M/dm.v";
static int ng1[] = {0, 0};
...
static unsigned int ng11[] = {388169730U, 0U};
...
LAB107:    *((unsigned int *)t362) = 1;

LAB109:    memset(t359, 0, 8);
    t378 = (t362 + 4);
...
LAB117:    if (*((unsigned int *)t385) > 0)
        goto LAB118;

LAB119:    if (*((unsigned int *)t359) > 0)
        goto LAB120;

LAB121:    memcpy(t358, t389, 8);

LAB122:    goto LAB100;

LAB101:    xsi_vlog_unsigned_bit_combine(t302, 32, t333, 32, t358, 32);
    goto LAB105;
...
LAB116:    t389 = ((char*)((ng11)));
    goto LAB117;

LAB118:    xsi_vlog_unsigned_bit_combine(t358, 32, t390, 32, t389, 32);
    goto LAB122;

LAB120:    memcpy(t358, t390, 8);
    goto LAB122;
...
extern void work_m_00000000000200147298_0010801604_init()
{
	static char *pe[] = {(void *)Initial_37_0,(void *)Cont_43_1,(void *)Cont_44_2,(void *)Always_53_3};
	xsi_register_didat("work_m_00000000000200147298_0010801604", "isim/mips_tb_isim_beh.exe.sim/work/m_00000000000200147298_0010801604.didat");
