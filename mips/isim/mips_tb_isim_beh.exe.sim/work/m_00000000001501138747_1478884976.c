...
#endif
static const char *ng0 = "C:/Users/ThinkPad/Documents/ISE/mips-bd/mips/mips/cpu/datapath/4_M/be.v";
...
LAB99:    memcpy(t7, t52, 8);

LAB100:    t92 = (t0 + 1012);
    xsi_vlogvar_assign_value(t92, t7, 0, 0, 4);
...
LAB123:    memcpy(t20, t8, 8);

LAB124:    t55 = (t0 + 1104);
    xsi_vlogvar_assign_value(t55, t20, 0, 0, 1);
    goto LAB13;
...
LAB144:    if (*((unsigned int *)t35) > 0)
        goto LAB145;

LAB146:    if (*((unsigned int *)t8) > 0)
        goto LAB147;

LAB148:    memcpy(t7, t42, 8);

LAB149:    t43 = (t0 + 1104);
    xsi_vlogvar_assign_value(t43, t7, 0, 0, 1);
    goto LAB13;
...
LAB47:    memcpy(t52, t97, 8);

LAB48:    goto LAB26;

LAB27:    xsi_vlog_unsigned_bit_combine(t7, 4, t47, 4, t52, 4);
    goto LAB31;

LAB29:    memcpy(t7, t47, 8);
    goto LAB31;
...
LAB64:    memcpy(t97, t142, 8);

LAB65:    goto LAB43;

LAB44:    xsi_vlog_unsigned_bit_combine(t52, 4, t92, 4, t97, 4);
    goto LAB48;

LAB46:    memcpy(t52, t92, 8);
    goto LAB48;
...
LAB67:    *((unsigned int *)t155) = 1;

LAB69:    memset(t143, 0, 8);
    t171 = (t155 + 4);
...
LAB81:    memcpy(t142, t187, 8);

LAB82:    goto LAB60;

LAB61:    xsi_vlog_unsigned_bit_combine(t97, 4, t137, 4, t142, 4);
    goto LAB65;

LAB63:    memcpy(t97, t137, 8);
    goto LAB65;
...
LAB74:    t182 = ((char*)((ng12)));
    goto LAB75;

LAB76:    t187 = ((char*)((ng13)));
    goto LAB77;

LAB78:    xsi_vlog_unsigned_bit_combine(t142, 4, t182, 4, t187, 4);
    goto LAB82;

LAB80:    memcpy(t142, t182, 8);
    goto LAB82;
...
LAB112:    if (*((unsigned int *)t81) > 0)
        goto LAB113;

LAB114:    if (*((unsigned int *)t53) > 0)
        goto LAB115;

LAB116:    memcpy(t52, t88, 8);

LAB117:    goto LAB95;

LAB96:    xsi_vlog_unsigned_bit_combine(t7, 4, t42, 4, t52, 4);
    goto LAB100;

LAB98:    memcpy(t7, t42, 8);
    goto LAB100;
...
LAB109:    t87 = ((char*)((ng14)));
    goto LAB110;

LAB111:    t88 = ((char*)((ng13)));
    goto LAB112;

LAB113:    xsi_vlog_unsigned_bit_combine(t52, 4, t87, 4, t88, 4);
    goto LAB117;

LAB115:    memcpy(t52, t87, 8);
    goto LAB117;
...
LAB145:    xsi_vlog_unsigned_bit_combine(t7, 32, t36, 32, t42, 32);
    goto LAB149;

LAB147:    memcpy(t7, t36, 8);
    goto LAB149;

}


extern void work_m_00000000001501138747_1478884976_init()
{
	static char *pe[] = {(void *)Cont_30_0,(void *)Always_33_1};
	xsi_register_didat("work_m_00000000001501138747_1478884976", "isim/mips_tb_isim_beh.exe.sim/work/m_00000000001501138747_1478884976.didat");
